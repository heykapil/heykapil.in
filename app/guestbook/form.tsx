  ...
  return (
    ...
    >
      ...
      <SubmitButton
        ...
        type="submit"
        className="flex items-center justify-center absolute right-1 top-1 px-2 py-1 font-medium h-8 bg-neutral-200 dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 rounded w-fit"
      >
        Sign
      </SubmitButton>
    </form>
