        ...
        <div>
          ...
          <div className='relative'>
            ...
            <div className='flex justify-between'>
              ...
              <span className='flex text-sm space-x-1.5 text-gray-500 self-start justify-end'>
                {/* Supported :{" "} */}
                <svg
                  width={25}
                  height={25}
                ...
                >
                  <g>
                    <path
                      d='M2,16V8H4l3,3,3-3h2v8H10V10.83l-3,3-3-3V16H2M16,8h3v4h2.5l-4,4.5-4-4.5H16Z'
                      strokeWidth={0.1}
                    ></path>
                  </g>
                </svg>
                <svg
                  ...
                  // className='bg-[var(--muted)]  rounded-md '
                  xmlns='http://www.w3.org/2000/svg'
                >
