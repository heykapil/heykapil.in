...
import { HomeIcon, SnippetIcon, BlogIcon, GalleryIcon} from '../Icons'
            ...
            <ul className="flex h-10 items-end justify-center space-x-2">
              ...
              <a
                ...
                >
                  ...
                  <span className={clsx('absolute -bottom-1 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full',
                  {
                    ['bg-none']:
                      '/' !== pathname,
                  },
              ...
              <a
                  ...
                  target=""
                >
                  <BlogIcon className="relative h-3/5 w-3/5" aria-hidden="true" />
                  <span className={clsx('absolute -bottom-1 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full',
                  {
                    ['bg-none']:
                      'blog' !== activepath,
              ...
              <a
                  ...
                  target=""
                >
                  <SnippetIcon className="relative h-3/5 w-3/5" aria-hidden="true" />
                  <span className={clsx('absolute -bottom-1 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full',
                  {
                    ['bg-none']:
                      'snippet' !== activepath,
              ...
              <a
                  ...
                  target="_blank"
                >
                  <GalleryIcon className="relative h-3/5 w-3/5" aria-hidden="true" />
                </a>
                </DockItem>
              <li className="self-center" aria-hidden="true">
                <hr className="!mx-2 block h-12 w-px border-none bg-[hsl(0,0%,50%)]" />
              </li>
              {/* <DockItem>
                <a
                  className="relative flex h-full w-full items-center justify-center"
