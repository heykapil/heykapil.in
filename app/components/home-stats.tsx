      ...
      <div className="columns-2 sm:columns-3 gap-4 my-8">
        <div className="relative h-40 mb-4 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
          <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 left-1/2 w-full h-full p-5 rounded-lg">
            {birthdayData ? (
              ...
              <div className=" items-center h-10 content-center place-content-center text-center"></div>
            )}
          </div>
        </div>
        <div className="relative flex h-80 mb-4 sm:mb-0 hover:rounded-lg">
          {spotifyData ? (
            ...
            <div className="flex-1 align-stretch min-h-0 items-center justify-center p-3 dark:hover:bg-neutral-700 bg-neutral-100 hover:bg-neutral-200 delay-50 duration-100 dark:bg-neutral-800 rounded-lg hover:rounded-lg group-hover:rounded-lg group hover:scale-[1.025] transition easy-in-out"></div>
          )}
        </div>
