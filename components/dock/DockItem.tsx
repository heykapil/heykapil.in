...
import { DockContextType, DockItemProps, MouseType } from '../../app/types'
  ...
  return (
    ...
    >
      <motion.button
        ref={ref}
        id={id}
        className="ui-box relative h-full w-full hover:bg-gradient-to-tr hover:bg-opacity-100 dark:hover:bg-opacity-30 hover:bg-gradient-to-r hover:from-rose-100 hover:via-pink-200 hover:to-orange-100 dark:hover:bg-gradient-to-r dark:hover:from-purple-500/30 dark:hover:via-fuchsia-500/30 dark:hover:to-pink-500/30 transition-all duration-0"
        aria-describedby={id}
        animate={controls}
        custom={spring}
        transition={{
