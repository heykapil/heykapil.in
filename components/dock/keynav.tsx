...
import { GitHubIcon, TwitterIcon,HomeIcon, FileIcon, BlogIcon, GalleryIcon, MailIcon} from '../Icons'
...
// show= showPopover , setShowPopover = useeshow
  ...
  return (
    <div className="key_nav flex">
      <div ref={targetRef} className="" onClick={() => parentFun()}><QuestionIcon className="relative h-[48px] w-[48px]" /></div>
