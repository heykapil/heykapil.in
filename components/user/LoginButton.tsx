    ...
    return (
      <div>
        <button onClick={() => signOut()}>
           {/* User Image  */}
          {session.user?.image ? (
          <div className="w-[48px] h-[48px] inline-flex items-center justify-center"><Image
        ...
        />
        </div>) : (<svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
