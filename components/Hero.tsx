              ...
              <div className="container flex flex-col px-0 md:px-2 py-0 mx-auto space-y-6 lg:h-fit lg:py-0 lg:flex-row lg:items-center">
                ...
                <motion.div className="lg:max-w-lg"
                  ...
                  variants={{
                    ...
                    <motion.h1 className="text-3xl font-semibold tracking-wide lg:text-4xl" variants={FADE_DOWN_ANIMATION_VARIANTS}>
                    Kapil Chaudhary
                    </motion.h1>

                    <motion.p className="mt-4" variants={FADE_DOWN_ANIMATION_VARIANTS}><span className="mb-4">
                    Ph.D. student at {' '}
