    ...
    <svg width={width} height={height} viewBox='0 0 24 24' {...props}>
      <g>
        ...
        <path
          ...
          fill='currentColor'
        ></path>
        <circle cx='76' cy='76' r='15' fill='currentColor'></circle>
...
export const BlogIcon = ({ height = 32, width = 32, ...props }: IconProps) => {
  return (
    <svg width={width} height={height} viewBox='0 0 512 512' {...props}>
      <path
        d='M100 323.265h60c11.046 0 20-8.954 20-20s-8.954-20-20-20h-60c-11.046 0-20 8.954-20 20s8.954 20 20 20zM100 243.265h60c11.046 0 20-8.954 20-20s-8.954-20-20-20h-60c-11.046 0-20 8.954-20 20s8.954 20 20 20zM217.441 303.265c0 11.046 8.954 20 20 20 41.821 0 81.139-16.286 110.711-45.858l146.26-146.274c23.448-23.447 23.452-61.402 0-84.853-23.393-23.394-61.458-23.394-84.853 0l-146.26 146.274c-29.571 29.573-45.858 68.89-45.858 110.711zm220.404-228.7c7.796-7.798 20.486-7.798 28.283 0 7.816 7.814 7.819 20.467 0 28.284L319.867 249.123c-16.719 16.72-37.624 27.735-60.352 32.068 4.333-22.727 15.349-43.632 32.067-60.352z'
        fill='currentColor'
        opacity='1'
      ></path>
      <path
        d='M60 483.265a59.92 59.92 0 0 0 39.992-15.27l27.647-24.73H332c55.141 0 100-44.86 100-100v-44.863c0-11.046-8.954-20-20-20s-20 8.954-20 20v44.863c0 33.084-26.916 60-60 60H120a20 20 0 0 0-13.334 5.093l-33.338 29.821A19.97 19.97 0 0 1 60 443.265c-11.028 0-20-8.972-20-20v-240c0-33.084 26.916-60 60-60h167.749c11.046 0 20-8.954 20-20s-8.954-20-20-20H100c-55.141 0-100 44.86-100 100v240c0 33.084 26.916 60 60 60z'
        fill='currentColor'
        opacity='0.45'
      ></path>
    </svg>
