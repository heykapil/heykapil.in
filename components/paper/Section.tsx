...
export function PaperSection() {
  return (
    <section className='relative'>
      ...
      />
      <svg
        className='absolute pointer-events-none inset-0 h-full w-full stroke-[var(--foreground)] opacity-25 [mask-image:radial-gradient(100%_100%_at_top_center,white,transparent)]'
        aria-hidden
      >
        <defs>
          <pattern
