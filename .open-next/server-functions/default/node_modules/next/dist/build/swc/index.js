...
const nextVersion = "15.0.0-canary.145";
...
function bindingToApi(binding, _wasm) {
   ...
   */ function invariant(never, computeMessage) {
    ...
    async function withErrorCause(fn) {
        try {
            ...
            throw new _turbopackutils.TurbopackInternalError(nativeError.message, {
                cause: nativeError
            });
        }
    }
   ...
   */ function augmentNextConfig(originalNextConfig, projectPath) {
    ...
    const createProject = async (options, turboEngineOptions)=>{
