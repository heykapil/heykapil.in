...
async function createHotReloaderTurbopack(opts, serverFields, distDir, resetFetch) {
    var _opts_nextConfig_experimental_turbo;
    ...
    const project = await bindings.turbo.createProject({
        ...
        memoryLimit: (_opts_nextConfig_experimental_turbo = opts.nextConfig.experimental.turbo) == null ? void 0 : _opts_nextConfig_experimental_turbo.memoryLimit
    });
    ...
    const hotReloader = {
        ...
        appPaths, definition, isApp, url: requestUrl }) {
            ...
            const normalizedAppPage = (0, _turbopackutils.normalizedPageToTurbopackStructureRoute)(page, (0, _path.extname)(routeDef.filename));
