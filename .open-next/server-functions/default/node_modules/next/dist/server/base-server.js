...
const _fallbackparams = require("../client/components/fallback-params");
...
const _responsehandlers = require("./route-modules/helpers/response-handlers");
...
const _postponed = require("./normalizers/request/postponed");
...
class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        this.normalizers = {
            ...
            postponed: this.isAppPPREnabled && this.minimalMode ? new _postponed.PostponedPathnameNormalizer() : undefined,
   ...
   */ async prepare() {
    ...
    setVaryHeader(req, res, isAppPath, resolvedPathname) {
        const baseVaryHeader = `${_approuterheaders.RSC_HEADER}, ${_approuterheaders.NEXT_ROUTER_STATE_TREE_HEADER}, ${_approuterheaders.NEXT_ROUTER_PREFETCH_HEADER}`;
        const isRSCRequest = (0, _requestmeta.getRequestMeta)(req, 'isRSCRequest') ?? false;
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
            ...
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    if (req.method === 'OPTIONS' && !is404Page) {
                        await (0, _sendresponse.sendResponse)(req, res, (0, _responsehandlers.handleBadRequestResponse)());
                        return null;
                    }
        ...
        const responseGenerator = async ({ hasResolved, previousCacheEntry, isRevalidating })=>{
            ...
            if (process.env.NEXT_RUNTIME !== 'edge' && !this.minimalMode && fallbackMode !== _fallback.FallbackMode.BLOCKING_STATIC_RENDER && staticPathKey && !didRespond && !isPreviewMode && isDynamic && (isProduction || !staticPaths || !isPageIncludedInStaticPaths)) {
                ...
                if ((0, _checks.isPagesRouteModule)(components.routeModule) && !isNextDataRequest) {
                ...
                } else if (isRoutePPREnabled && this.nextConfig.experimental.pprFallbacks && (0, _checks.isAppPageRouteModule)(components.routeModule) && !isRSCRequest) {
                    // We use the response cache here to handle the revalidation and
                    // management of the fallback shell.
                    ...
                    async ()=>doRender({
                            ...
                            // here.
                            postponed: undefined,
                            fallbackRouteParams: isProduction ? (0, _fallbackparams.getFallbackRouteParams)(pathname) : null
                        }), {
            ...
            if ((isDebugStaticShell || isDebugDynamicAccesses) && typeof context.postponed !== 'undefined') {
                return {
                    revalidate: 1,
                    isFallback: false,
                    value: {
        ...
        if (ssgCacheKey && !this.minimalMode && isRoutePPREnabled && this.nextConfig.experimental.pprFallbacks && ((_cacheEntry_value = cacheEntry.value) == null ? void 0 : _cacheEntry_value.kind) === _responsecache.CachedRouteKind.APP_PAGE && cacheEntry.isFallback && !isOnDemandRevalidate) {
        ...
        if (minimalPostponed) {
            ...
            revalidate = 0;
        } else if (typeof cacheEntry.revalidate !== 'undefined' && (!this.renderOpts.dev || hasServerProps && !isNextDataRequest)) {
