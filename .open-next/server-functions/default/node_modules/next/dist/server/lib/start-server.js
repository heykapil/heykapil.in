...
let startServerSpan;
async function getRequestHandlers({ dir, port, isDev, onCleanup, server, hostname, minimalMode, keepAliveTimeout, experimentalHttpsServer, quiet }) {
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"15.0.0-canary.145"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
